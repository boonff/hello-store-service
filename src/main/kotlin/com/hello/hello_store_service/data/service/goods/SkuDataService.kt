...
class SkuDataService(
    ...
    fun fetchDetail(skuId: String): com.hello.hello_store_service.web.model.view.goods.SkuDetail? =
        fetchById(skuId)?.let { skuEntity ->
            com.hello.hello_store_service.web.model.view.goods.SkuDetail.from(skuEntity)
        }

    fun fetchDetails(skuId: String): List<com.hello.hello_store_service.web.model.view.goods.SkuDetail> =
