...
data class OrderView(
    ...
    val orderItemVOs: List<com.hello.hello_store_service.web.trans.view.order.OrderItemView>,    // 商品列表
    val logisticsVO: com.hello.hello_store_service.web.trans.view.order.LogisticsView,           // 物流信息
    val paymentVO: com.hello.hello_store_service.web.trans.view.order.PaymentView,               // 支付信息
    val buttonVOs: List<com.hello.hello_store_service.web.trans.view.order.ButtonView>,          // 订单操作按钮列表
